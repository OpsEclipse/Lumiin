        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight text-foreground mb-6 leading-[1.1]">
              Your Biometric <br className="hidden lg:block" />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="text-lg px-8 py-6 shadow-xl shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-1 transition-all group">
              ...
              <Button asChild variant="outline" size="lg" className="text-lg px-8 py-6">
                <a href="#features">
                  <PlayCircle size={20} weight="fill" className="mr-2 text-muted-foreground" />
                  How it works
                </a>
              </Button>
            </div>
            ...
            <div className="relative w-full max-w-md aspect-video bg-card border-4 border-border shadow-2xl overflow-hidden z-20">
              ...
              >
                ...
                <circle
                  ...
                  r="3"
                />
                <circle cx="185" cy="95" fill="currentColor" r="2" />
                <circle cx="215" cy="95" fill="currentColor" r="2" />
                <circle cx="200" cy="110" fill="currentColor" r="2" />
              </svg>
